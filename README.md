...
![Build](https://github.com/NHSDigital/ratings-and-reviews/workflows/Build/badge.svg?branch=master)

This is a specification for the *ratings-and-reviews* API.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/ratings-and-reviews/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/ratings-and-reviews/blob/master/CODE_OF_CONDUCT.md).
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `ratings-and-reviews-target`.
